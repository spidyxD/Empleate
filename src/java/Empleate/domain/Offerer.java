...
public class Offerer  implements java.io.Serializable {
     ...
     @Expose private double location_X;
     @Expose private double location_Y;
     @Expose private String residence;
     @Expose private int login;
     @Expose private int active;
     private Set<Offercategory> offercategories = new HashSet<>(0);
    ...
    public Offerer(int idOfferer, String nameOfferer, String lastname, 
            String nationality, String email, String phone, String residence,int login,int active) {
        this.idOfferer = idOfferer;
        this.nameOfferer = nameOfferer;
        this.lastname = lastname;
        this.nationality = nationality;
